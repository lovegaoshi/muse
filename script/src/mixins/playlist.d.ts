...
export declare function get_playlist_tracks_only(playlistId: string, options?: GetPlaylistOptions, stopAfter?: (tracks: PlaylistItem[]) => boolean): Promise<Partial<Playlist>>;
