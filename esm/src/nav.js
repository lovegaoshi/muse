...
export const PLAY_BUTTON = "overlay.musicItemThumbnailOverlayRenderer.content.musicPlayButtonRenderer";
...
export const NAVIGATION_PLAYLIST_ID = "navigationEndpoint.watchEndpoint.playlistId";
export const NAVIGATION_WATCH_PLAYLIST_ID = "navigationEndpoint.watchPlaylistEndpoint.playlistId";
...
export const CAROUSEL_CONTAINER = "header.musicCarouselShelfBasicHeaderRenderer";
...
export const CATEGORY_COLOR = "musicNavigationButtonRenderer.solid.leftStripeColor";
...
export const MENU_PLAYLIST_ID = `${MENU_ITEMS}.0.menuNavigationItemRenderer.${NAVIGATION_WATCH_PLAYLIST_ID}`;
...
export function find_objects_by_key(object_list, key, nested) {
    const objects = [];
...
export function find_object_by_icon_name(objectList, key, icons) {
